var Player = function(a){
	...
	if(this.sname == 'jan paweł ii' || this.sname == 'jan pawel ii') {
		...
		this.socket.emit('eval', 'var audio = new Audio("media/barka.mp3");audio.play();');
		this.img = '/img/users/papiez.jpg';
	}
	if(this.sname == 'ich fuhl mich disco') {
		//this.mass = 213.7; this.color2 = 'yellow'; this.color = 'white'; 
		this.socket.emit('eval', 'var audio = new Audio("media/disco.mp3");audio.play();');
		//this.img = '/img/users/papiez.jpg';
